                            ...
                            <div class="lg:w-1/2 md:w-2/3 ">
                                <div class="-m-2">
                                    ...
                                    <div class="p-2 w-full flex justify-around mt-4">
                                        <button onclick="location.href='{{route('admin.owners.index')}}'" class="mx-auto text-white bg-indigo-500 border-0 py-2 px-8 focus:outline-none hover:bg-indigo-600 rounded text-lg hy-03">戻る</button>
                                        <button class="mx-auto text-white bg-indigo-500 border-0 py-2 px-8 focus:outline-none hover:bg-indigo-600 rounded text-lg hy-03">登録</button>
                                    </div>
                                </div>
                            </div>
                        </div>
